...
public class MessageBuffer {
     ...
     *
     * @param structuredRecord The record to be added.
     */
    public void add(StructuredRecord structuredRecord) {
        buffer.add(structuredRecord);
    }
    ...
    private String getBufferAsJsonList() throws IOException {
        ...
        for (StructuredRecord structuredRecord : buffer) {
            sb.append(StructuredRecordStringConverter.toJsonString(structuredRecord));
            sb.append(delimiter);
        }
        if (!buffer.isEmpty()) {
